...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ViewInteraction appCompatAutoCompleteTextView = onView(
                allOf(withId(R.id.autoCompleteTextView),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatAutoCompleteTextView.perform(replaceText("he"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatAutoCompleteTextView2 = onView(
                allOf(withId(R.id.autoCompleteTextView), withText("helium"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                0),
                        isDisplayed()));
        appCompatAutoCompleteTextView2.perform(replaceText("heliu"));

        ViewInteraction appCompatAutoCompleteTextView3 = onView(
                allOf(withId(R.id.autoCompleteTextView), withText("heliu"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatAutoCompleteTextView5 = onView(
                allOf(withId(R.id.autoCompleteTextView), withText("heliu"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatAutoCompleteTextView5.perform(replaceText("he"));

        ViewInteraction appCompatAutoCompleteTextView6 = onView(
                allOf(withId(R.id.autoCompleteTextView), withText("he"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
